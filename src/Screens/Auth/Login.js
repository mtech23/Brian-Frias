...
const AdminLogin = () => {
    ...
    useEffect(() => {
        document.title = 'Brian Frias Admin | Login';
    }, [])
    ...
    return (
        <>
            <AuthLayout authTitle='Brian Frias' authPara='Login into your Account'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-4 text-center">
                        <CustomButton variant='primaryButton' text='Logins' type='submit' />
